...
export class RegisterDto {
  ...
  @IsEmail()
  email!: string;
  @ApiPropertyOptional({ type: String, example: 'linh_demo', minLength: 3, maxLength: 50 })
  @IsOptional()
  @IsString()
  @Matches(/^[A-Za-z0-9_][A-Za-z0-9_.-]{2,49}$/)
  username?: string;
...
export class UpdateProfileDto {
  ...
  @ApiPropertyOptional({
    type: String,
    example: 'vi',
    enum: ['en', 'vi', 'fr', 'de', 'es', 'pt', 'ja'],
  })
  @IsOptional()
  @IsIn(['en', 'vi', 'fr', 'de', 'es', 'pt', 'ja'])
  locale?: string;
